...
Yes, it will, becouse such approch reduces issue with machine tolerance comparence
|#
...
(run-tests
    (test-suite "Exercise 1.7"
        ...
        (test-case "Check list of second variant of sqrt procedures
                ...
                (check-within (list (sqrt2 4) (sqrt2 9) (sqrt2 25)) (list 2 3 5) tolerance)
                )
        )
)